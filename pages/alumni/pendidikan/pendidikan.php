...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
            <i class='bx bx-book <?= $iconColor ?>'></i>
            Pendidikan Saya
        </h1>

        <a href="dashboard_alumni.php?page=pendidikan-tambah"
    ...
    <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-md hover:shadow-xl 
                ...
                <div class="p-5">
                    ...
                    <div class="mb-4 flex items-center gap-2">
                        <i class='bx bx-medal text-green-500 text-lg'></i>
                    ...
                    <div class="flex gap-2 mt-4">
                        ...
                        <a href="dashboard_alumni.php?page=pendidikan-edit&id=<?= $row['id'] ?>"
                        ...
                        <a href="?page=pendidikan-hapus&id=<?= $row['id'] ?>"
        ...
        <?php else: ?>
            ...
            <div class="col-span-full flex flex-col items-center justify-center 
                ...
                <i class='bx bx-book text-5xl mb-3'></i>
